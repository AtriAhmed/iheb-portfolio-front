...
export default function AddWorkCmp(props) {
    ...
    const itemSubmit = (e) => {
        ...
        axios.put(`/update-work/${props.toedit._id}`, formData).then(res => {
        ...
        <div className='max-w-xl mx-auto h-100 flex justify-center items-center'>
            ...
            <form className='flex flex-col gap-4 w-full' onSubmit={itemSubmit} encType='mutlipart/form-data'>
                <div>
                    ...
                    <textarea placeholder='Description' type="text" name="description" onChange={handleInput} value={Input.description} className='block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none' />
                ...
                <button type="submit" className="self-center w-[50%] bg-blue-500 hover:bg-blue-700 rounded-full py-3 text-white font-bold">Edit Work</button>
